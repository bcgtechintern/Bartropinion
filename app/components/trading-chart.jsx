  ...
  return (
    <div className="relative w-full h-[300px] sm:h-[400px] md:h-[500px] overflow-hidden rounded-3xl bg-black/20 backdrop-blur-sm border border-white/10 p-4 md:p-6 ">
      <div className="absolute top-4 sm:top-6 left-4 sm:left-6 right-4 sm:right-6 flex flex-col sm:flex-row justify-between gap-2 sm:gap-4 z-10">
        ...
        >
          <div className="text-xs sm:text-sm text-blue-400">Current Price</div>
          <div className="text-lg sm:text-2xl font-bold text-white">₹{data[data.length - 1]?.toFixed(2)}</div>
        </motion.div>
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          ...
          className="bg-white/5 backdrop-blur-md rounded-2xl p-3 sm:p-4 flex-1 text-center"
        >
          <div className="text-xs sm:text-sm text-green-400">24h High</div>
          <div className="text-lg sm:text-2xl font-bold text-white">₹{Math.max(...data).toFixed(2)}</div>
        </motion.div>
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          ...
          className="bg-white/5 backdrop-blur-md rounded-2xl p-3 sm:p-4 flex-1 text-center"
        >
          <div className="text-xs sm:text-sm text-red-400">24h Low</div>
          <div className="text-lg sm:text-2xl font-bold text-white">₹{Math.min(...data).toFixed(2)}</div>
        </motion.div>
      </div>
